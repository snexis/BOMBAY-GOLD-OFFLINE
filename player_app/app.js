...
function renderSingleBoard() {
    ...
    SingleData.forEach(item => {
        ...
        // Added 'premium-gaming-card' for modern 3D UI
        ...
        // Injected bet-amount-badge to show placed points dynamically
        cell.innerHTML = `
    ...
    syncBoardBetDisplays(); // Ensure badges show if already selected
}
...
// NEW FUNCTION: Syncs the visual bet amount directly to the boxes smoothly
function syncBoardBetDisplays() {
    // 1. Reset all badges first
    ...
    // 2. Loop through selected cart and activate specific badges
...
function updateCartDisplay() {
    ...
    if (AppState.selectedCart.length === 0) {
        ...
        syncBoardBetDisplays(); // Update board UI visually
        return;
    }
